...
if has("cscope")
    ...
    " the new window.
    "
    " (Note: earlier versions of vim may not have the :vert scs command, but it
    ...
    nmap <Leader>\t :vert scs find t <C-R>=expand("<cword>")<CR><CR>	
    ...
    nmap <Leader>\<Leader>\t :scs find t <C-R>=expand("<cword>")<CR><CR>
